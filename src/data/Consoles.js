let consolas = [
    {
        ...
        control: true,
        resolucion: " 2560 px x 1440 px.",
        ram: "10 GB",
        tipoDeMemoria: "GDDR6 ",
        producto: {
            idProducto: 4,
            titulo: "CONSOLA XBOX SERIES S",
            precio: 7599.0,
            condicion: "nuevo",
            plataforma: "XSX",
            garantia: "3 años",
            descripcion: "Disfruta de una velocidad y rendimiento de nueva generación con nuestra biblioteca digital más grande hasta la fecha. \n Disfruta de mundos más dinámicos y tiempos de carga más rápidos, y agrega Xbox Game Pass Ultimate (la suscripción se vende por separado) \n para jugar a títulos nuevos el mismo día de su lanzamiento. Además, disfruta de cientos de juegos de alta calidad.",
            publicador: "MICROSOFT",
            lanzamiento: "10 de Noviembre 2020"
        },
        listaFotos: [
            {
                idFoto: 10,
    ...
    },
    {
        ...
        producto: {
            ...
            plataforma: "PS4",
            garantia: "3 años",
            descripcion: "Disfruta de una PS4 más estilizada y compacta, entrega la energía de juego impresionante que siempre es para los jugadores. \n Tambien, disfruta de colores increíblemente vivos y brillantes con los asombrosos gráficos HDR.\n\nUn 30% más delgada y un 16% más ligera que el modelo de PS4 original.",
            publicador: "SONY",
            lanzamiento: "16  de Diciembre 2022"
        },
        listaFotos: [
            {
                idFoto: 13,
